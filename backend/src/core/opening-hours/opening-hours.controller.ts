...
export function listOpeningHoursController(
    req: express.Request,
...
export function getOpeningHoursPerDayController(
    req: express.Request,
    res: express.Response,
) {
